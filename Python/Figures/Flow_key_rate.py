...
# 示例数据（请替换为您自己的数据）
x = np.arange(0, 5)
y1 = [38, 53.1, 25.5, 22.5, 22.3]
y2 = [19, 31, 19.2, 14.9, 11.1]
...
ax.set_ylabel('Flow key upload rate', fontweight='bold')
...
# 保存图表（按需调整文件格式和分辨率）
plt.savefig('./Flow_key_rate.pdf', bbox_inches='tight')  # PDF适合论文提交
